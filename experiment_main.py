...
def main():
    ...
    # for net in nets:
    #     print(summary(net, input_size=(3, 1024, 1024)))
    ...
    criterion.__setattr__(weight = [0.0, 0.1])
    print('criterion.getattrb : ', criterion.__getattr__(weight))
    ...
    for k_fold in [2, 1, 0]:
        ...
        net.to(device)
        # print(summary(net, input_size=(3, 512, 512)))
